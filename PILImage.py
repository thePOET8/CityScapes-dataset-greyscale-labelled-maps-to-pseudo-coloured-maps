...
# 示例用法
image_folder = 'F:/rightImg8bit_trainvaltest/rightImg8bit/val/'
mask_folder = 'F:/gtFine_trainvaltest/gtFine/val/'
...
mask_files = [file for file in glob.glob(mask_folder + '*.png') if 'labelIds' in os.path.basename(file)]
